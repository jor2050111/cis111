# Exercise Template (CIS111: Ethics in Information Technology)
...
exercise meaningful to community college students in an introductory IT ethics course, including IT majors and general education students. Scenarios should involve genuine
...
* 90% of CIS111 students should complete successfully
...
* 70% of CIS111 students should complete successfully
...
Add any of these blocks when a standalone exercise needs more scaffolding. Code samples below come from a Python-based course. Adapt them to a modern web browser, Canvas LMS, and Microsoft Word with PDF export.

### Starter Code

```python
# EXAMPLE from a Python-based course. Adapt to a modern web browser, Canvas LMS, and Microsoft Word with PDF export.
