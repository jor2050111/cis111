<!--
GENERIC CHAPTER TEMPLATE for CIS111: Ethics in Information Technology

Replace these placeholder tokens before authoring:
  CIS111      Course code (example: CIS123)
  Ethics in Information Technology   Full course title
  community college students in an introductory IT ethics course, including IT majors and general education students       Who the students are and what they already know
  None (chapters teach from zero)  Required prior courses or skills
  a modern web browser, Canvas LMS, and Microsoft Word with PDF export  The course tech stack (languages, environments, libraries)
...
a modern web browser, Canvas LMS, and Microsoft Word with PDF export.
-->

# Chapter N: [Descriptive Title]

[Opening narrative paragraph. Hook the reader with an industry-relevant scenario tied to the chapter topic. Make it meaningful to community college students in an introductory IT ethics course, including IT majors and general education students.]

[Second paragraph. Explain why this topic matters in Ethics in Information Technology. Connect to course learning outcomes and to prior chapters where the connection is genuine.]
...
* **CLO N.** [Verbatim outcome text from docs/CIS111_CLOs.md]

[List only this chapter's aligned CLOs (usually 1-3), taken from the
CLO-to-chapter mapping table in docs/CIS111_CLOs.md. Quote the
...
# Adapt the language, libraries, and task to a modern web browser, Canvas LMS, and Microsoft Word with PDF export.
...
* [Resource 2 Title](URL) - [Why this is valuable for community college students in an introductory IT ethics course, including IT majors and general education students]
* [Resource 3 Title](URL) - [What students will learn]

**Note:** Curate 3-6 resources matched to community college students in an introductory IT ethics course, including IT majors and general education students. Include official documentation, tutorials, industry articles, or interactive exercises at the right depth for the course level.
...
* [ ] CLO alignment block after the MLO list (verbatim outcome text
      from docs/CIS111_CLOs.md, no heading icon)
...
COURSE-SPECIFIC REQUIREMENTS (adapt each to a modern web browser, Canvas LMS, and Microsoft Word with PDF export):
...
* Tone matched to community college students in an introductory IT ethics course, including IT majors and general education students
* Split prose sentences before they reach 35 words
* All code tested and working on a modern web browser, Canvas LMS, and Microsoft Word with PDF export
