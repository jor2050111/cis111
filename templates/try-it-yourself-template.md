# Try It Yourself Template (Predict-Run-Explain Pattern): CIS111
...
* Focus on common pitfalls in a modern web browser, Canvas LMS, and Microsoft Word with PDF export, calibrated to community college students in an introductory IT ethics course, including IT majors and general education students
...
## Examples (from a Python-based course, adapt to a modern web browser, Canvas LMS, and Microsoft Word with PDF export)
