...
* **Deliverables:** Try It Yourself activities, Quick Checks, Skills Lab 4A
...
1. Name three ethical concerns with how social media platforms obtain user consent for data collection, and explain why each matters.
2. What is a filter bubble, and how do recommendation algorithms create them? Why is this an ethical problem and not just a technical one?
3. A social media platform discovers that its recommendation algorithm promotes content linked to self-harm among teenage users. Using two ethical frameworks from Chapter 1, explain what the platform should do and why.

---

## 4.6 Skills Lab 4A: Social Media Ethics Audit

**Goal:** Audit a social platform choice across economic, legal, ethical, and privacy concerns.

**Evidence packet:** `assets/code/chapter-04/social-media-audit-case.md`, a fictional case and evidence packet created for this textbook.
...
1. Which platform practice creates the strongest conflict between autonomy and profit?
2. What evidence would you require before accepting the platform's safety claim?
