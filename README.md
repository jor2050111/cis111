...
**An applied guide to ethical reasoning, professional responsibility, privacy, security, and emerging technology decisions in information technology.**

## Project Overview

This project is the OER textbook for CIS111 (Ethics in Information Technology) at
...
Its 12 chapters are schedule-neutral and can support courses with
different term lengths.

### Target Audience

* community college students in an introductory IT ethics course, including IT majors and general education students
...
[docs/CIS111_CLOs.md](docs/CIS111_CLOs.md). It contains the
...
├── assets/
│   └── code/                          # Student evidence pack for Skills Labs
...
│   ├── CIS111_CLOs.md          # Official Course Learning Outcomes
...
1. **Clone the repository:**
   ...
   ```bash
   git clone https://github.com/jor2050111/cis111.git
   cd cis111
   ```
...
3. **Review and refine:** check learning objectives against Bloom's
   Taxonomy, verify factual claims and links, and confirm terminology
...
* [ ] Legal, technical, and current-event claims verified
* [ ] All required source links and evidence files present
* [ ] Terminology matches glossary
* [ ] Heading hierarchy correct (no skipped levels)
* [ ] Prerequisite concepts referenced, not retaught
* [ ] Evidence packets ship in the course pack (assets/code/chapter-NN/)
...
This textbook is licensed under
